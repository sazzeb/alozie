...
function _generate_pagination($data)
{
    ...
    //$chief, $target_base_url, $total_rows, $offset_segment, $limit
    ...
    if ($chief=="odara") {
        $settings = $this->get_settings_for_odara();
    }
...
function get_settings_for_odara()
{
...
/*
function get_settings_for_some_chief()
{
    $settings['num_links'] = '';
