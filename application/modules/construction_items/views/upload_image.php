...
echo form_open_multipart('construction_items/do_upload/'.$update_id, $attributes);
...
?>
                    ...
                    <fieldset>
                      <div class="control-group" style="height: 80px;">
                        ...
                        <input class="input-file form-control uniform_on" id="fileInput" name="userfile" type="file">
                        </div>
                        </div>      
