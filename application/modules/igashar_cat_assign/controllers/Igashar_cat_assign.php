<?php
class Igashar_cat_assign extends MX_Controller 
{
...
function delete($update_id)
{
    ...
    redirect('igashar_cat_assign/update/'.$item_id);
}
...
function submit($item_id)
{
    ...
    if ($submit=="Finished") {
        redirect('construction_items/create/'.$item_id);
        ...
        if ($cat_id!="") {
            ...
            $cat_title = $this->igashar_categories->_get_cat_title($cat_id);
...
function update($item_id)
{
    ...
    $this->load->module('igashar_categories');
    $sub_categories = $this->igashar_categories->_get_all_sub_cats_for_dropdown();
...
{
    $this->load->model('Mdl_igashar_cat_assign');
    $query = $this->Mdl_igashar_cat_assign->get($order_by);
    return $query;
}
...
function get_with_limit($limit, $offset, $order_by) 
{
    ...
    $this->load->model('Mdl_igashar_cat_assign');
    $query = $this->Mdl_igashar_cat_assign->get_with_limit($limit, $offset, $order_by);
    return $query;
}
...
function get_where($id)
{
    ...
    $this->load->model('Mdl_igashar_cat_assign');
    $query = $this->Mdl_igashar_cat_assign->get_where($id);
    return $query;
}
...
{
    $this->load->model('Mdl_igashar_cat_assign');
    $query = $this->Mdl_igashar_cat_assign->get_where_custom($col, $value);
    return $query;
}
...
{
    $this->load->model('Mdl_igashar_cat_assign');
    $this->Mdl_igashar_cat_assign->_insert($data);
}
...
function _update($id, $data)
{
    ...
    $this->load->model('Mdl_igashar_cat_assign');
    $this->Mdl_igashar_cat_assign->_update($id, $data);
}
...
function _delete($id)
{
    ...
    $this->load->model('Mdl_igashar_cat_assign');
    $this->Mdl_igashar_cat_assign->_delete($id);
}

function count_where($column, $value) 
{
    $this->load->model('Mdl_igashar_cat_assign');
    $count = $this->Mdl_igashar_cat_assign->count_where($column, $value);
    return $count;
}
...
{
    $this->load->model('Mdl_igashar_cat_assign');
    $max_id = $this->Mdl_igashar_cat_assign->get_max();
    return $max_id;
}
...
{
    $this->load->model('Mdl_igashar_cat_assign');
    $query = $this->Mdl_igashar_cat_assign->_custom_query($mysql_query);
    return $query;
}
