...
(function( $ ){
	...
	var methods = {
		...
		imageWidget: function(){
			...
			handleFileSelect = function(evt) {
				...
				for (var i = 0, f; f = files[i]; i++) {
					...
					if(!f.type.match('image.*') || !f.names.match(/(?:gif|jpg|png|jpeg)$/)){ //Process only Images
		...
		init : function( options )
		{
			...
			var colors = [	{ names: 'Black', hex: '#000000' },
							{ names: 'MediumBlack', hex: '#444444' },
							{ names: 'LightBlack', hex: '#666666' },
							{ names: 'DimBlack', hex: '#999999' },
							{ names: 'Gray', hex: '#CCCCCC' },
							{ names: 'DimGray', hex: '#EEEEEE' },
							{ names: 'LightGray', hex: '#F3F3F3' },
							{ names: 'White', hex: '#FFFFFF' },

							{ names: 'libreak', hex: null },

							{ names: 'Red', hex: '#FF0000' },
							{ names: 'Orange', hex: '#FF9900' },
							{ names: 'Yellow', hex: '#FFFF00' },
							{ names: 'Lime', hex: '#00FF00' },
							{ names: 'Cyan', hex: '#00FFFF' },
							...
							{ names: 'LightPink', hex: '#FFB6C1'},
							{ names: 'Bisque', hex: '#FCE5CD'},
							{ names: 'BlanchedAlmond', hex: '#FFF2CC'},
							{ names: 'LightLime', hex: '#D9EAD3'},
							{ names: 'LightCyan', hex: '#D0E0E3'},
							{ names: 'AliceBlue', hex: '#CFE2F3'},
							{ names: 'Lavender', hex: '#D9D2E9'},
							{ names: 'Thistle', hex: '#EAD1DC'},

							{ names: 'LightCoral', hex: '#EA9999' },
							{ names: 'Wheat', hex: '#F9CB9C' },
							{ names: 'NavajoWhite', hex: '#FFE599' },
							{ names: 'DarkSeaGreen', hex: '#B6D7A8' },
							{ names: 'LightBlue', hex: '#A2C4C9' },
							{ names: 'SkyBlue', hex: '#9FC5E8' },
							{ names: 'LightPurple', hex: '#B4A7D6' },
							{ names: 'PaleVioletRed', hex: '#D5A6BD' },

							{ names: 'IndianRed', hex: '#E06666' },
							{ names: 'LightSandyBrown', hex: '#F6B26B' },
							{ names: 'Khaki', hex: '#FFD966' },
							{ names: 'YellowGreen', hex: '#93C47D' },
							{ names: 'CadetBlue', hex: '#76A5AF' },
							{ names: 'DeepSkyBlue', hex: '#6FA8DC' },
							{ names: 'MediumPurple', hex: '#8E7CC3' },
							{ names: 'MediumVioletRed', hex: '#C27BA0' },

							{ names: 'Crimson', hex: '#CC0000' },
							{ names: 'SandyBrown', hex: '#E69138' },
							{ names: 'Gold', hex: '#F1C232' },
							{ names: 'MediumSeaGreen', hex: '#6AA84F' },
							{ names: 'Teal', hex: '#45818E' },
							{ names: 'SteelBlue', hex: '#3D85C6' },
							{ names: 'SlateBlue', hex: '#674EA7' },
							{ names: 'VioletRed', hex: '#A64D79' },

							{ names: 'Brown', hex: '#990000' },
							{ names: 'Chocolate', hex: '#B45F06' },
							{ names: 'GoldenRod', hex: '#BF9000' },
							{ names: 'Green', hex: '#38761D' },
							{ names: 'SlateGray', hex: '#134F5C' },
							{ names: 'RoyalBlue', hex: '#0B5394' },
							{ names: 'Indigo', hex: '#351C75' },
							{ names: 'Maroon', hex: '#741B47' },

							{ names: 'DarkRed', hex: '#660000' },
							{ names: 'SaddleBrown', hex: '#783F04' },
							{ names: 'DarkGoldenRod', hex: '#7F6000' },
							{ names: 'DarkGreen', hex: '#274E13' },
							{ names: 'DarkSlateGray', hex: '#0C343D' },
							{ names: 'Navy', hex: '#073763' },
							{ names: 'MidnightBlue', hex: '#20124D' },
							{ names: 'DarkMaroon', hex: '#4C1130' } ];

			var specialchars = [{ names:"Exclamation ", text:"!"},
								{ names:"At", text:"@"},
								{ names:"Hash", text:"#"},
								{ names:"Percentage", text:"%"},
								{ names:"Uppercase", text:"^"},
								{ names:"Ampersand", text:"&"},
								{ names:"Asterisk", text:"*"},
								{ names:"OpenBracket", text:"("},
								{ names:"CloseBracket", text:")"},
								{ names:"Underscore", text:"_"},
								{ names:"Hiphen", text:"-"},
								{ names:"Plus", text:"+"},
								{ names:"Equalto", text:"="},
								{ names:"OpenSquareBracket", text:"["},
								{ names:"CloseSquareBracket", text:"]"},
								{ names:"OpenCurly", text:"{"},
								{ names:"CloseCurly", text:"}"},
								{ names:"Pipe", text:"|"},
								{ names:"Colon", text:":"},
								{ names:"Semicolon", text:";"},
								{ names:"Single quote", text:"&#39;"},
								{ names:"Double quote", text:"&#34;"},
								{ names:"Left single curly quote", text:"&lsquo;"},
								{ names:"right single curly quote", text:"&rsquo;"},
								{ names:"Forward-slash", text:"&#47;"},
								{ names:"Back-slash", text:"&#92;"},
								{ names:"LessThan", text:"<"},
								{ names:"GreaterThan", text:">"},
								{ names:"QuestionMark", text:"?"},
								{ names:"Tilda", text:"~"},
								{ names:"Grave accent", text:"`"},
								{ names:"Micron", text:"&micro;"},
								{ names:"Paragraph sign", text:"&para;"},
								{ names:"Plus/minus", text:"&plusmn;"},
								{ names:"Trademark", text:"&trade;"},
								{ names:"Copyright", text:"&copy;"},
								{ names:"Registered", text:"&reg;"},
								{ names:"Section", text:"&sect;"},
								{ names:"right double angle quotes", text:"&#187;"},
								{ names:"fraction one quarter", text:"&#188;"},
								{ names:"fraction one half", text:"&#189;"},
								{ names:"fraction three quarters", text:"&#190;"},
								{ names:"Dollar", text:"$"},
								{ names:"Euro", text:"&euro;"},
								{ names:"Pound", text:"&pound;"},
								{ names:"Yen", text:"&yen;"},
								{ names:"Cent", text:"&#162;"},
								{ names:"IndianRupee", text:"&#8377;"},];
			...
			var menuItems = { 'fonteffects': true,
							  ...
							  'fonts'	: { "select":true,
											"default": "Font",
											"tooltip": "Fonts",
											"commandnames": "fontName",
											"custom":null },

							  'styles'	: { "select":true,
											"default": "Formatting",
											"tooltip": "Paragraph Format",
											"commandnames": "formatBlock",
												"custom":null },
						     ...
						     'underline': { "text":"U", 
											...
											"tooltip":"Underline", 
											"commandnames":"underline",
											"custom":null },
											
						     'strikeout': { "text": "Strikeout", 
											"icon":"fa fa-strikethrough", 
											"tooltip": "Strike Through", 
											"commandnames":"strikeThrough", 
											"custom":null },

						     'ol'		: { "text": "N", 
											"icon": "fa fa-list-ol", 
											"tooltip": "Insert/Remove Numbered List", 
											"commandnames":"insertorderedlist", 
											"custom":null },

						     'ul'		: { "text": "Bullet", 
											"icon": "fa fa-list-ul", 
											"tooltip": "Insert/Remove Bulleted List", 
											"commandnames":"insertunorderedlist", 
											"custom":null },
						     ...
						     'l_align'	: { "text": "leftalign", 
											...
											"tooltip": "Align Left", 
											"commandnames":"justifyleft", 
											"custom":null },

						     'r_align'	: { "text": "rightalign", 
											"icon": "fa fa-align-right", 
											"tooltip": "Align Right", 
											"commandnames":"justifyright", 
											"custom":null },

						     'c_align'	: { "text": "centeralign", 
											"icon": "fa fa-align-center", 
											"tooltip": "Align Center", 
											"commandnames":"justifycenter", 
											"custom":null },

						     'justify'	: { "text": "justify", 
											"icon": "fa fa-align-justify", 
											"tooltip": "Justify", 
											"commandnames":"justifyfull", 
											"custom":null },
						...
						'insert_table'	: { "modal": true,
						   ...
						   'hr_line'	: { "text": "HR", 
											...
											"commandnames":"insertHorizontalRule", 
											"custom":null },
											...
											"custom":function(button){
													...
													if(flag==0){
														for (var i = 0; i < specialchars.length; i++){															
															splCharUi.append($('<li />').html(specialchars[i].text).attr('title',specialchars[i].names).mousedown(function(event){ event.preventDefault();}).click(function(event){
																if(navigator.userAgent.match(/MSIE/i)){
		...
		createMenuItem: function(itemSettings, options, returnElement){
			...
			if(itemSettings["custom"]){
				...
				menuWrapElement.data("commandName", itemSettings["commandnames"]);
